...
void LoadTextures(Game* _game)
{
	...
	_game->mTexManager.LoadTexture(L"Resources/images/game_clear.png", 32);
}
...
void LoadShaders(Game* _game)
{
	...
	_game->mShaderManager.LoadShader(L"Shader/MainSceneFlippingLayer_vertex.hlsl", DX12Config::ShaderType::VERTEX, 28);
